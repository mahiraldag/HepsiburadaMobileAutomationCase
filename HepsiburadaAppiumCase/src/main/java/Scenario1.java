...
public class Scenario1 {
    ...
    By locationSavedPopUpClose = By.id("com.pozitron.hepsiburada:id/ivClose"); //"Konumunuz kaydedildi"
    ...
    public void enterLocationDetails() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(randomCity)).click();  //Afyon
        wait.until(ExpectedConditions.visibilityOfElementLocated(districtDropdown)).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(randomDistrict)).click();  // Bolvadin
    ...
    // Tries to click on "X" to both check & close the pop-up
